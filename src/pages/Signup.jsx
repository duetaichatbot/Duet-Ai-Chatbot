    ...
    <div className="signup_container">
      <div className="item_1">
        <div className="form_container">
          ...
          <span className="signup_span">Signup please</span>
          </div>
          {/* form-inputs */}
          <form className="signup_form">
            ...
            <br />
            <br />
            <input className="checkbox_input" type="checkbox" name="tc" onChange={handleRegisterField} />
            <label className="checkbox_label" htmlFor="">Agree term & Condition</label>
            <br />

            <div className="signup_btn_div">
            <button className="signup_btn" onClick={handleRegister}>SIGN UP</button>
            </div>
          </form>
